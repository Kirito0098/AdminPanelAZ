...
export const SECTION_META: Record<SettingsSection, SectionMeta> = {
  ...
  updates: {
    ...
    hint: 'Перед обновлением сделайте резервную копию. Панель ненадолго перезапустится.',
  },
  panel_ops: {
    title: 'Перезапуск и пересборка',
    description: 'Сборка интерфейса и перезапуск сервиса adminpanelaz',
    hint: 'Используйте после изменения .env или файлов frontend на сервере — без загрузки новой версии из Git.',
  },
  tests: {
