...
export default function Awg2InstallPrompt({ health, activeNode }: Awg2InstallPromptProps) {
      ...
      <div className="mx-auto mt-2 max-w-xl space-y-3">
        <div className="flex items-start gap-2 rounded-lg border bg-muted/30 p-3 text-sm">
          ...
          <p className="text-muted-foreground">
            Уже установили на другом VPN-сервере? Выберите его в селекторе узла справа вверху. Панель не запускает install.sh сама — только показывает команду.
          </p>
        </div>
        <div>
