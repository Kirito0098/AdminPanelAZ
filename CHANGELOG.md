...
> **Кратко:** Telegram — OIDC-вход, несколько получателей уведомлений и бэкапов, объединённая вкладка «Бот и авторизация», сворачиваемые инструкции; NOC — расширенные сводки и PNG-дашборд; единый карточный формат TG-алертов; мониторинг — TB, доля трафика, live CPU, графики ресурсов.
