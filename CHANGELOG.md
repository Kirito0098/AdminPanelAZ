...
> **Кратко:** мониторинг сервера — исправлен live CPU, графики ресурсов, понятные названия интерфейсов, улучшен hover на графиках; мониторинг трафика — ускорена загрузка overview и убран дублирующий запрос.
