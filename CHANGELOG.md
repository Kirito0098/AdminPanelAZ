...
- **Мониторинг трафика** — произвольный диапазон дат (таблица и график раздельно), ограниченный сроком хранения сэмплов.

### 🔄 Changed

- Колонки 1д/7д/30д заменены на «За период»; в Обслуживании уточнены подсказки для «Трафик, дн.».
