...
FEATURE_TOGGLES: tuple[FeatureToggleDefinition, ...] = (
    ...
    FeatureToggleDefinition(
        ...
        description="Вкладки «Адрес сайта и HTTPS» и «Cloudflare»: публикация панели, домен, reverse-proxy и proxy-mode.",
        icon="🌐",
        disable_hint="Вкладки «Адрес сайта и HTTPS» и «Cloudflare» будут недоступны.",
        resource_impact_level="minimal",
        default=True,
        group="app_module",
