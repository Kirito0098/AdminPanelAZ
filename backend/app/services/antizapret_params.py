...
ANTIZAPRET_PARAMS = [
    ...
    },
    {
        ...
        "type": "choice",
        "default": "1",
        "html_id": "ANTIZAPRET_WARP-select",
        "title": "Cloudflare WARP for Antizapret",
        "description": "Исходящий трафик AntiZapret VPN (antizapret-*) через встроенный Cloudflare WARP AntiZapret",
        "options": [
            {"value": "1", "label": "None — не использовать"},
            {"value": "2", "label": "All — весь трафик (домены и IP)"},
            {"value": "3", "label": "Domain — домены AntiZapret и include-warp-hosts.txt"},
            {"value": "4", "label": "Custom — только include-warp-hosts.txt"},
        ],
        # Старый AntiZapret-VPN: y/n. Режимы 3/4 в y/n не выражаются.
        "legacy_flag": {"y": "2", "n": "1"},
    },
    {
        "key": "VPN_WARP",
        ...
        "type": "choice",
        "default": "1",
        "html_id": "VPN_WARP-select",
        "title": "Cloudflare WARP for VPN outbound",
        "description": "Исходящий трафик полного VPN (vpn-*) через встроенный Cloudflare WARP AntiZapret",
        "options": [
            {"value": "1", "label": "None — не использовать"},
            {"value": "2", "label": "All — весь трафик (домены и IP)"},
        ],
