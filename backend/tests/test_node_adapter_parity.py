...
REMOTE_ADAPTER_ENDPOINTS: dict[str, str] = {
    ...
    "download_antizapret_backup": "GET /backups/antizapret/download",
    "restore_antizapret_backup": "POST /backups/antizapret/restore",
    "get_antizapret_fingerprints": "GET /backups/antizapret/fingerprints",
    ...
    "get_warper_health": "GET /warper/health",
    "get_warper_status": "GET /warper/status",
    "get_warper_doctor": "GET /warper/doctor",
    "warper_toggle": "POST /warper/toggle",
    "get_warper_domains": "GET /warper/domains",
    "get_warper_domain_lists": "GET /warper/domains",
    "add_warper_domain": "POST /warper/domains",
    "remove_warper_domain": "DELETE /warper/domains/{domain:path}",
    "sync_warper_domains": "POST /warper/domains/sync",
    "add_warper_domains_bulk": "POST /warper/domains/bulk",
    "set_warper_domain_list": "POST /warper/domains/lists/{name}",
    "get_warper_user_domains_text": "GET /warper/domains/text",
    "save_warper_user_domains_text": "PUT /warper/domains/text",
    "get_warper_ip_ranges": "GET /warper/ip-ranges",
    "add_warper_ip_range": "POST /warper/ip-ranges",
    "remove_warper_ip_range": "DELETE /warper/ip-ranges/{cidr:path}",
    "get_warper_ip_ranges_text": "GET /warper/ip-ranges/text",
    "save_warper_ip_ranges_text": "PUT /warper/ip-ranges/text",
    "sync_warper_ip_ranges": "POST /warper/ip-ranges/sync",
    "set_warper_ip_route_mode": "POST /warper/ip-ranges/mode",
    "set_warper_ip_export": "POST /warper/ip-ranges/export",
    "get_warper_traffic": "GET /warper/traffic",
    "get_warper_logs": "GET /warper/logs",
    "get_warper_mode": "GET /warper/settings/mode",
    "get_warper_settings_options": "GET /warper/settings/options",
    "set_warper_mode_warp": "POST /warper/settings/mode/warp",
    "set_warper_mode_slave": "POST /warper/settings/mode/slave",
    "set_warper_mode_wg": "POST /warper/settings/mode/wg",
    "set_warper_fullvpn": "PUT /warper/settings/fullvpn",
    "set_warper_subnet": "PUT /warper/settings/subnet",
